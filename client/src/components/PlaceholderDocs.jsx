      ...
      {open && (
        <div style={{ padding: '0 14px 14px' }}>
          ...
          <div style={{ marginTop: 10, padding: 10, background: '#0a1422', border: '1px solid #1e3a5f', borderRadius: 6, color: '#93c5fd', fontSize: '0.74rem', lineHeight: 1.5 }}>
            <strong>Post-download redirect:</strong> With a <strong>Post-download page</strong> (brand store page) selected, clicking download sends the visitor straight to the store page — nothing downloads on the landing page. The store page fires the download immediately on load — no click, no wait; the Install button fades and locks, then flips to "Downloaded". With an external <strong>redirect URL</strong> instead, the download fires on the landing page and the redirect follows ~0.5s later.
          </div>
        </div>
      )}
    </div>
